...
import Animated, { Extrapolate, interpolate, useAnimatedScrollHandler, useAnimatedStyle, useSharedValue, withDelay, withTiming, runOnJS } from 'react-native-reanimated'

import { LineDivider, IconButton, HorizontalCourseCard, FilterModal } from '../../components'
import { COLORS, dummyData, FONTS, icons, images, SIZES } from '../../constants'

const AnimatedFlatList = Animated.createAnimatedComponent(FlatList)
const HEADER_HEIGHT = 250

const CourseListing = ({ navigation, route }: any) => {
    ...
    function RenderHeader() {
        ...
        const headerHeaderHeightOnScrollAnimatedStyle = useAnimatedStyle(() => {
            return {
            ...
            >
                ...
                <Animated.View
                    style={[{
                        ...
                        headerHeaderHeightOnScrollAnimatedStyle
                    ]}
                >
                    <SharedElement
    ...
    function RenderResults() {
        return (
            <AnimatedFlatList
                ...
                keyExtractor={(item: any) => `Results-${item.id}`}
                ...
                ListHeaderComponent={
                    ...
                    >
                        ...
                        <IconButton
                            ...
                            onPress={() => {
                                filterModelSharedValue1.value = withTiming(0, {
                                    duration: 100
                                })
                                filterModelSharedValue2.value = withDelay(100, withTiming(0, {
                                    duration: 500
                                }))
                            }}
                        />
    ...
    return (
        ...
        >
            ...
            {/* Filter model */}
            <FilterModal filterModelSharedValue1={filterModelSharedValue1} filterModelSharedValue2={filterModelSharedValue2} />
        </View>
    )
}


CourseListing.sharedElements = (route: any, otherRoute: any, showing: any) => {
    const { category, sharedElementPrefix } = route.params
    return [
        {
            id: `${sharedElementPrefix}-CategoryCard-Bg-${category?.id}`
